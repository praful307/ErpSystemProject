...
namespace ErpSystem_Services.Implementation
{
    public class CourseTopicsService : ICourseTopicsService
    {
        ...
        public Task<CourseTopicsModel> GetCourseTopicById(int courseTopicId)
        {
            CourseTopicsModel courseTopic = null;
            ...
            using (SqlConnection con = new SqlConnection(ConnectionString.Connection))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("sp_FetchCourseTopics", con))
                {
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        if (dr.Read())
                        {
                            courseTopic = new CourseTopicsModel
                            {
            ...
            return Task.FromResult(courseTopic);
        }


        public Task<List<CourseTopicsModel>> GetCourseTopics()
        {
            con.Close();
        ...
        public Task<List<ContentModel>> GetTopicAndContentByCourseId(int courseId)
        {
            con.Close();
